...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: '플러터 데모 앱'),  //표시할 화면의 인스턴스
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // _counter 변수를 1 증가시키고 화면을 다시 그리는 메서드
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  // 머티리얼 디자인 기본 뼈대 위젯
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: _incrementCounter, // 클릭시 _incrementCounter() 메서드를 실행
        tooltip: 'Increment',
        child: const Icon(Icons.add), //상단앱바
